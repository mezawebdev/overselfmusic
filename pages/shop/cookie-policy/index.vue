<template>
    <div class="cookie-policy">
        <div class="container">
            ...
            <h1>Cookie Policy</h1>
            <p>Updated at 2021-02-07</p>
            <h1>Definitions and key terms</h1>
            <p>To help explain things as clearly as possible in this Cookie Policy, every time any of these terms are referenced, are strictly defined as:
                <ul>
                    ...
                    <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Overself, that is responsible for your information under this Cookie Policy.</li>
                    <li>Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit Overself and use the services.</li>
                    ...
                    <li>Service: refers to the service provided by Overself as described in the relative terms (if available) and on this platform. </li>
                    ...
                    <li>Website:  site, which can be accessed via this URL: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="9cfefdf2f8dcf3eaf9eeeff9f0faf1e9eff5ffb2fff3f1">[email&#160;protected]</a></li>
                </ul>
            </p>

            <h1>Introduction</h1>
            <p>This Cookie Policy explains how Overself and its affiliates (collectively "Overself", "we", "us", and "ours"), use cookies and similar technologies to recognize you when you visit our website, including without limitation <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1c7e7d72785c736a796e6f79707a71696f757f327f7371">[email&#160;protected]</a> and any related URLs, mobile or localized versions and related domains / sub-domains ("Websites"). It explains what these technologies are and why we use them, as well as the choices for how to control them.</p>
            ...
            <p>We use first party and/or third party cookies on our website for various purposes such as:</p>
                <ul>
                    ...
                    <li>You: a person or entity that is registered with Overself to use the Services.</li>
                </ul>
            <h1>What type of cookies does Overself use?</h1>
            ...
            <ul>
                <li>Via this Link:  https://overselfmusic.com/contact</li>
            </ul>
